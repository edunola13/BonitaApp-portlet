...
<script>
	$(document).ready(function(){
		var locale= "<%=renderRequest.getLocale() %>";
	   	$('#tabla-bonita-adminOrg').dataTable( { //CONVERTIMOS NUESTRO LISTADO DE LA FORMA DEL JQUERY.DATATABLES- PASAMOS EL ID DE LA TABLA
	...
	<%if(renderRequest.getAttribute("scrollToPortlet") != null){ %>
	   	document.getElementById("bonita-adminOrg").scrollIntoView(true);
	<%} %>
</script>